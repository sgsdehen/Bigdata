...
object E03_ReadFromJdbc {
  def main(args: Array[String]): Unit = {
    ...
    val df1 = spark.read.jdbc("jdbc:mysql://118.178.239.176:3306/test?useSSL=false&characterEncoding=UTF-8&useUnicode=true&user=root&password=123456", "inInterval", new Properties())
